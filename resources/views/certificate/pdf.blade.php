...
<head>
    ...
    <title>{{$certificate->patient->name}}</title>
</head>
<body>
    <header>
        <div class="logo">
        ...
        <div class="receta">
            <div class="nombre-doctor">Dr. {{ $certificate->doctor->name }}</div>
    ...
    <div> {{ $certificate->patient->name }} {{ $certificate->patient->dni }} </div>
    <div>Indicaciones: {{ $certificate->description }}</div>

    <div class="firma">
        <hr>
        <p>Firma Dr. {{ $certificate->doctor->name }} </p>
    </div>
